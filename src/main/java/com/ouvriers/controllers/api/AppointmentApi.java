...
public interface AppointmentApi {
    ...
    @GetMapping(value = APP_ROOT + "/appointments/searchTop10PendingAppointmentsOrderByIdDesc", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Renvoi la liste des 10 derniers Appointments par l'ID de l'ouvrier",
            notes = "Cette méthode permet de chercher et renvoyer la liste des 10 derniers Appointments par l'ID de l'ouvrier", responseContainer = "List<Appointment>")
    @ApiResponses(value = {
